...
export class DatabaseConfig {
  ...
  public static readonly MONGO_INITDB_HOST: string =
    process.env.MONGO_INITDB_HOST || '';
  public static readonly MONGO_INITDB_PORT: number =
    parseInt(process.env.MONGO_INITDB_PORT || '', 10) || 0;
  public static readonly MONGO_INITDB_NAME: string =
    process.env.MONGO_INITDB_NAME || '';
  public static readonly MONGO_INITDB_ROOT_USERNAME: string =
    process.env.MONGO_INITDB_ROOT_USERNAME || '';
  public static readonly MONGO_INITDB_ROOT_PASSWORD: string =
